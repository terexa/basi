...
class VentaControllerTest < ActionController::TestCase
  ...
  test "should create ventum" do
    assert_difference('Ventum.count') do
      post :create, ventum: { cantidad: @ventum.cantidad, cliente: @ventum.cliente, notas: @ventum.notas, producto: @ventum.producto }
    end
  ...
  test "should update ventum" do
    put :update, id: @ventum, ventum: { cantidad: @ventum.cantidad, cliente: @ventum.cliente, notas: @ventum.notas, producto: @ventum.producto }
    assert_redirected_to ventum_path(assigns(:ventum))
  end
