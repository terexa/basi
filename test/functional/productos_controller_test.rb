...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { description: @producto.description, name: @producto.name, picture: @producto.picture }
    end
  ...
  test "should update producto" do
    put :update, id: @producto, producto: { description: @producto.description, name: @producto.name, picture: @producto.picture }
    assert_redirected_to producto_path(assigns(:producto))
  end
